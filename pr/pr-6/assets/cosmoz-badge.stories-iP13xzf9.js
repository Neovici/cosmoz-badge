import{A as H,b as h,w as M,D as Y}from"./iframe-Cwz8gVSA.js";import"./preload-helper-PPVm8Dsz.js";const x=e=>e??H;function j(e,t,s){return e?t(e):s?.(e)}const Z=({slot:e,title:t,className:s,width:r="24",height:o="24",styles:n}={})=>h`
  <svg
    slot=${x(e)}
...
`,m={args:{variant:"default",size:"lg",shape:"rounded",label:"Default"},render:me},v={render:()=>h`
    ...
    `,parameters:{docs:{description:{story:"The two shape variants available for the badge."}}}},y={args:{size:"lg"},render:e=>h`
        <div class="story-row">
            <cosmoz-badge variant="warning" size=${e.size}>
                ${Z({width:"16",height:"16",slot:"prefix"})}
                Warning
            </cosmoz-badge>
            <cosmoz-badge variant="error" size=${e.size}>
...
}`,...y.parameters?.docs?.source}}};const we=["Default","Variants","Shapes","WithIcons"];export{m as Default,z as Shapes,v as Variants,y as WithIcons,we as __namedExportsOrder,ye as default};
